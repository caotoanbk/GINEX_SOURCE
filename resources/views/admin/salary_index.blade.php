...
<form action="/ssurvey/salary-excel" method="post" class="mb-3" enctype="multipart/form-data">
    ...
    ?>
    {!! Form::select('company_id',$companies, null,['placeholder' => 'công ty', 'style' => 'padding: 3px', 'required'] ) !!}
    <select name="SalaryYear" style="padding: 3px"><option value="2019">Năm 2019</option><option value="2020">Năm 2020</option></select>
    &nbsp;<input type="file" name="file" style="max-width: 210px;" required>&nbsp;<button type="submit" class="btn btn-primary btn-sm"><i class="fas fa-arrow-right"></i>&nbsp;upload</button>
</form>
